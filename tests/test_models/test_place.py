...
class TestPlace_Instance(unittest.TestCase):
    ''' Test instance of the Place class '''
    ...
    def test_two_places_unique_ids(self):
        f_pl = Place()
        s_pl = Place()
        self.assertNotEqual(f_pl.id, s_pl.id)

    def test_two_places_different_created_at(self):
        f_pl = Place()
        sleep(0.05)
        s_pl = Place()
        self.assertLess(f_pl.created_at, s_pl.created_at)

    def test_two_places_different_updated_at(self):
        f_pl = Place()
        sleep(0.05)
        s_pl = Place()
        self.assertLess(f_pl.updated_at, s_pl.updated_at)
...
class TestPlace_Save(unittest.TestCase):
    ''' Test save method of the Place class '''
...
class TestPlace_To_Dict(unittest.TestCase):
    ''' Test to_dict method of the Place class '''
    ...
    def test_to_dict_contains_added_attributes(self):
        pl = Place()
        pl.middle_name = 'Caleb'
        pl.my_number = 98
        self.assertEqual('Caleb', pl.middle_name)
