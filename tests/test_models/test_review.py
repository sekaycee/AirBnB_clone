...
class TestReview_Instance(unittest.TestCase):
    ...
    def test_two_reviews_unique_ids(self):
        f_rv = Review()
        s_rv = Review()
        self.assertNotEqual(f_rv.id, s_rv.id)
    ...
    def test_two_reviews_different_updated_at(self):
        ...
        sleep(0.05)
        s_rv = Review()
        self.assertLess(f_rv.updated_at, s_rv.updated_at)
...
class TestReview_Save(unittest.TestCase):
    ''' Test save method of the Review class '''
...
class TestReview_To_Dict(unittest.TestCase):
    ''' Test to_dict method of the Review class '''
    ...
    def test_to_dict_contains_added_attributes(self):
        rv = Review()
        rv.middle_name = 'Caleb'
        rv.my_number = 98
        self.assertEqual('Caleb', rv.middle_name)
