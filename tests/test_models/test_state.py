...
class TestState_Instance(unittest.TestCase):
    ...
    def test_two_states_unique_ids(self):
        f_st = State()
        s_st = State()
        self.assertNotEqual(f_st.id, s_st.id)

    def test_two_states_different_created_at(self):
        f_st = State()
        sleep(0.05)
        s_st = State()
        self.assertLess(f_st.created_at, s_st.created_at)

    def test_two_states_different_updated_at(self):
        f_st = State()
        sleep(0.05)
        s_st = State()
        self.assertLess(f_st.updated_at, s_st.updated_at)
...
class TestState_Save(unittest.TestCase):
    ''' Test save method of the State class '''
...
class TestState_To_Dict(unittest.TestCase):
    ''' Test to_dict method of the State class '''
    ...
    def test_to_dict_contains_added_attributes(self):
        st = State()
        st.middle_name = 'Caleb'
        st.my_number = 98
        self.assertEqual('Caleb', st.middle_name)
