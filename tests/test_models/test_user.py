...
class TestUser_Instance(unittest.TestCase):
    ...
    def test_two_users_unique_ids(self):
        f_us = User()
        s_us = User()
        self.assertNotEqual(f_us.id, s_us.id)

    def test_two_users_different_created_at(self):
        f_us = User()
        sleep(0.05)
        s_us = User()
        self.assertLess(f_us.created_at, s_us.created_at)

    def test_two_users_different_updated_at(self):
        f_us = User()
        sleep(0.05)
        s_us = User()
        self.assertLess(f_us.updated_at, s_us.updated_at)
...
class TestUser_To_Dict(unittest.TestCase):
    ''' Test to_dict method of the User class '''
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = 'Caleb'
        us.my_number = 98
        self.assertEqual('Caleb', us.middle_name)
